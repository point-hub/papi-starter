...
import type { IFieldHistoriesRepository } from '../repositories/field-histories.repository';
...
export interface IDeps {
  fieldHistoriesRepository: IFieldHistoriesRepository
 ...
 */
export class FieldHistoriesUseCase extends BaseUseCase<IInput, IDeps, ISuccessData> {
  async handle(input: IInput): Promise<IUseCaseOutputSuccess<ISuccessData> | IUseCaseOutputFailed> {
    ...
    // Retrieve all data from the database.
    const response = await this.deps.fieldHistoriesRepository.handle(input.query);
